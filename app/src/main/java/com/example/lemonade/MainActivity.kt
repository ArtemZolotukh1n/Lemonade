...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        when (lemonadeState) {
            SELECT -> {
                binding.textAction.text = getString(R.string.select)
                binding.imageLemonState.setImageResource(R.drawable.lemon_tree)
            }
            SQUEEZE -> {
                binding.textAction.text = getString(R.string.juice)
                binding.imageLemonState.setImageResource(R.drawable.lemon_squeeze)
            }
            DRINK -> {
                binding.textAction.text = getString(R.string.drink)
                binding.imageLemonState.setImageResource(R.drawable.lemon_drink)
            }
            RESTART -> {
                binding.textAction.text = getString(R.string.start)
